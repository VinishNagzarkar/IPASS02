        ...
        <div className="row">
          <div className="col-4">
            <div className="price">
              ...
              <h1 className="price__heading">Pizza Type 1</h1>
          ...
          <div className="col-4">
            <div className="price">
              ...
              <h1 className="price__heading">Pizza Type 2</h1>
              <p className="price__text">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi minus ut mollitia error molestiae quia.
              </p>
          ...
          <div className="col-4">
            <div className="price">
              ...
              <h1 className="price__heading">Pizza Type 3</h1>
              <p className="price__text">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi minus ut mollitia error molestiae quia.
              </p>
              <p className="price_rs">Rs.150</p>
          ...
          <div className="col-4">
            <div className="price">
              ...
              <h1 className="price__heading">Pizza Type 4</h1>
              <p className="price__text">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi minus ut mollitia error molestiae quia.
              </p>
              <p className="price_rs">Rs.220</p>
            </div>
          </div>
          ...
          <div className="col-4">
            <div className="price">
              ...
              <h1 className="price__heading">Pizza Type 5</h1>
              <p className="price__text">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi minus ut mollitia error molestiae quia.
              </p>
          ...
          <div className="col-4">
            <div className="price">
              ...
              <h1 className="price__heading">Pizza Type 6</h1>
              <p className="price__text">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi minus ut mollitia error molestiae quia.
              </p>
